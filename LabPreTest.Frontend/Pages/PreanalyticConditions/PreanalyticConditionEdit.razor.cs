...
namespace LabPreTest.Frontend.Pages.PreanalyticConditions
{
    ...
    public partial class PreanalyticConditionEdit
    {
        ...
        {
            var responseHttp = await Repository.GetAsync<PreanalyticCondition>($"PreanalyticConditions/{Id}");
        ...
        {
            var responseHttp = await Repository.PutAsync("/PreanalyticConditions", preanalyticCond);
            if (responseHttp.Error)
            {
